...
function FAQ() {
  return (
    <>
      <h1 className="py-5 text-md md:text-3xl flex justify-center items-center font-bold">
        আপনার সকল প্রশ্নের উত্তর{" "}
      </h1>
      <div className="join join-vertical w-full bg-[#AAACE5] flex justify-center items-center mb-5">
          ...
          <div className="collapse-content bg-white pt-3">
            ...
            <div className="grid grid-cols-1 gap-2 mt-2">
              <a
                ...
                className="w-full md:w-1/6 px-2 py-2 font-semibold text-white rounded bg-blue-600 hover:bg-blue-800"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-full md:w-1/5 px-2 py-2 font-semibold text-white rounded bg-green-600 hover:bg-green-800"
              >
